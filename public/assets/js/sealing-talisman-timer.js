...
// [begin...end)
var periods = [['2015/04/16 15:00:00', '2015/04/23 10:00:00'], ['2015/04/23 15:00:00', '2015/04/30 10:00:00']].map(function (period) {
...
var maps = [{
  ...
  stamina: 12,
  expectation: 22,
  drops: [{ name: '封印の札5', icon: 'sealing-talisman-5', set: 3 }, { name: '封印の札3', icon: 'sealing-talisman-3', set: 2 }, { name: '封印の札1', icon: 'sealing-talisman-3', set: 1 }, { name: '虹精霊', icon: 'rainbow-sprit' }]
}, {
  name: '封妖の忍者',
  charisma: 70,
  stamina: 8,
  expectation: 13,
  drops: [{ name: '封印の札5', icon: 'sealing-talisman-5', set: 2 }, { name: '封印の札1', icon: 'sealing-talisman-1', set: 3 }, { name: 'サノスケ', icon: 'sanosuke' }, { name: 'ニエル', icon: 'niel' }]
}, {
  name: '妖怪牛鬼',
  charisma: 40,
  stamina: 5,
  expectation: 7,
  drops: [{ name: '封印の札3', icon: 'sealing-talisman-3', set: 2 }, { name: '封印の札1', icon: 'sealing-talisman-1', set: 1 }, { name: 'ローレン', icon: 'loren' }, { name: '魔水晶', icon: 'demon-crystal-1', set: 3 }]
}, {
  name: '大妖怪ぬらりひょん',
  charisma: 50,
  stamina: 7,
  expectation: 11,
  drops: [{ name: '封印の札3', icon: 'sealing-talisman-3', set: 3 }, { name: '封印の札1', icon: 'sealing-talisman-1', set: 2 }, { name: 'カゲロウ', icon: 'kagerou' }, { name: 'プラチナアーマー', icon: 'platinum-bucket' }]
}, {
  name: '妖怪封じの要石',
  charisma: 40,
  stamina: 4,
  expectation: 5,
  drops: [{ name: '封印の札3', icon: 'sealing-talisman-3', set: 1 }, { name: '封印の札1', icon: 'sealing-talisman-1', set: 2 }, { name: 'ハリッサ', icon: 'harissa' }, { name: 'ヴァレリー', icon: 'valerie' }]
}, {
  name: '疾風の刃',
  charisma: 30,
  stamina: 2,
  expectation: 2,
  drops: [{ name: '封印の札1', icon: 'sealing-talisman-1', set: 2 }, { name: 'ロザリー', icon: 'rosalie' }, { name: '水晶', icon: 'crystal' }]
}, {
  name: '襲われた住民',
  charisma: 20,
  stamina: 1,
  expectation: 1,
  drops: [{ name: '封印の札1', icon: 'sealing-talisman-1', set: 2 }]
}];
