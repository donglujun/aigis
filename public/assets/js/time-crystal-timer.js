...
// [begin...end)
var periods = [['2015/03/14 00:00:00', '2015/03/16 00:00:00'], ['2015/03/21 00:00:00', '2015/03/23 00:00:00'], ['2015/03/28 00:00:00', '2015/03/30 00:00:00'], ['2015/04/04 00:00:00', '2015/04/06 00:00:00']].map(function (period) {
...
var prizes = [{ value: 500, unit: 'time-sprit', name: '時の精霊', limit: 1 }, { value: 150, unit: 'ekidona', name: 'エキドナ', limit: Infinity }];
...
var maps = [{
  ...
  stamina: 5,
  expectation: 5.49,
  drops: [{ name: 'ガドラス', icon: 'gadrus', set: 2 }, { name: '竜戦士', icon: 'dragon-soldier' }, { name: '刻水晶3', icon: 'time-crystal-2', set: 3 }]
}, {
  name: '決戦',
  charisma: 40,
  stamina: 5,
  expectation: 6,
  drops: [{ name: 'ガドラス', icon: 'gadrus' }, { name: '竜戦士', icon: 'dragon-soldier' }, { name: '刻水晶2', icon: 'time-crystal-2', set: 3 }]
}, {
  name: '竜の巣',
  charisma: 35,
  stamina: 4,
  expectation: 4.56,
  drops: [{ name: 'ガドラス', icon: 'gadrus' }, { name: '竜戦士', icon: 'dragon-soldier', set: 2 }, { name: '刻水晶3', icon: 'time-crystal-2', set: 2 }]
}, {
  name: '闇の世界',
  charisma: 30,
  stamina: 3,
  expectation: 3,
  drops: [{ name: 'ガドラス', icon: 'gadrus' }, { name: '竜戦士', icon: 'dragon-soldier' }, { name: '刻水晶1', icon: 'time-crystal-1', set: 3 }]
}, {
  name: '竜王',
  charisma: 70,
  stamina: 3,
  expectation: 3.44,
  drops: [{ name: 'ガドラス', icon: 'gadrus', set: 2 }, { name: '竜戦士', icon: 'dragon-soldier', set: 2 }, { name: '刻水晶2', icon: 'time-crystal-2', set: 2 }]
}, {
  name: 'ドラゴニュート',
  charisma: 40,
  stamina: 2,
  ...
  stamina: 2,
  expectation: 1.92,
  drops: [{ name: 'ガドラス', icon: 'gadrus' }, { name: '竜戦士', icon: 'dragon-soldier' }, { name: '刻水晶1', icon: 'time-crystal-1', set: 2 }]
}, {
  name: '再侵攻',
  charisma: 20,
  stamina: 1,
  expectation: 0.71,
  drops: [{ name: 'ガドラス', icon: 'gadrus' }, { name: '竜戦士', icon: 'dragon-soldier' }, { name: '刻水晶1', icon: 'time-crystal-1' }]
}, {
  name: '大地の大穴',
  charisma: 10,
  stamina: 0,
