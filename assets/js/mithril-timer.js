...
// [begin...end)
var periods = [['2015/06/11 15:00:00', '2015/06/18 10:00:00'], ['2015/06/18 15:00:00', '2015/06/25 10:00:00']].map(function (period) {
...
var maps = [{
  ...
  stamina: 1,
  expectation: 0,
  drops: [{ name: 'ミスリル鉱1', icon: 'mithril-1', set: 1 }]
}, {
  name: '硬質の魔物',
  charisma: 30,
  stamina: 2,
  expectation: 0,
  drops: [{ name: 'ミスリル鉱1', icon: 'mithril-1', set: 3 }, { name: 'ハリッサ', icon: 'harissa' }, { name: '魔水晶1', icon: 'demon-crystal-1' }]
}, {
  name: 'ミスリル争奪戦',
  charisma: 40,
  stamina: 4,
  expectation: 0,
  drops: [{ name: 'ミスリル鉱3', icon: 'mithril-3', set: 2 }, { name: 'ミスリル鉱1', icon: 'mithril-1', set: 1 }, { name: 'モーティマ', icon: 'motima' }, { name: '花束', icon: 'flower' }]
}, {
  name: '交錯する陣容',
  charisma: 50,
  stamina: 7,
  expectation: 11,
  drops: [{ name: 'ミスリル鉱3', icon: 'mithril-3', set: 3 }, { name: 'ミスリル鉱1', icon: 'mithril-1', set: 2 }, { name: 'カズハ', icon: 'kazuha' }, { name: '魔水晶2', icon: 'demon-crystal-2' }]
}, {
  name: '怒涛の炎獣',
  charisma: 80,
  stamina: 9,
  expectation: 0,
  drops: [{ name: 'ミスリル鉱5', icon: 'mithril-5', set: 4 }, { name: 'フドウ', icon: 'fudou' }, { name: '白バケツ', icon: 'platinum-bucket' }, { name: '極上酒', icon: 'hq-liquor' }]
}, {
  name: '痺れる毒針',
  charisma: 40,
  stamina: 5,
  expectation: 0,
  drops: [{ name: 'ミスリル鉱3', icon: 'mithril-3', set: 2 }, { name: 'ミスリル鉱1', icon: 'mithril-1', set: 1 }, { name: 'カズハ', icon: 'rosalie' }, { name: '白精霊', icon: 'platinum-sprit' }]
}, {
  name: '目覚まし機甲兵',
  charisma: 70,
  stamina: 8,
  expectation: 0,
  drops: [{ name: 'ミスリル鉱5', icon: 'mithril-5', set: 2 }, { name: 'ミスリル鉱3', icon: 'mithril-3', set: 2 }, { name: 'アリサ', icon: 'arisa' }, { name: 'ルビー', icon: 'ruby' }]
}, {
  name: '魔の決戦兵器',
  charisma: 90,
  stamina: 12,
  expectation: 0,
  drops: [{ name: 'ミスリル鉱5', icon: 'mithril-5', set: 4 }, { name: 'ミスリル鉱3', icon: 'mithril-3', set: 2 }, { name: '虹精霊', icon: 'rainbow-sprit' }]
}, {
  name: '妖精郷の決戦',
  charisma: 100,
  stamina: 2,
  expectation: 0,
  drops: [{ name: '金精霊', icon: 'gold-sprit' }, { name: '白精霊', icon: 'platinum-sprit' }, { name: '黒精霊', icon: 'black-sprit' }, { name: '虹精霊', icon: 'rainbow-sprit' }]
}];
...
function initialize() {
  ...
  maps.forEach(function (map, i) {
    ...
    $('<tr />').attr('data-map', i).append($('<th />').text(map.name)).append($('<td />').text('' + map.charisma + '/' + map.stamina)).append(function () {
