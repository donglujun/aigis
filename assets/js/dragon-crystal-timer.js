...
// [begin...end)
var periods = [['2015/02/14 00:00:00', '2015/02/16 00:00:00'], ['2015/02/21 00:00:00', '2015/02/23 00:00:00'], ['2015/02/28 00:00:00', '2015/03/02 00:00:00'], ['2015/03/07 00:00:00', '2015/03/09 00:00:00']].map(function (period) {
...
var prizes = [{ value: 70, unit: 'aria', name: 'アリア', limit: Infinity }, { value: 300, unit: 'drania', name: 'ドラニア', limit: Infinity }];
...
var maps = [{
  ...
  stamina: 3,
  expectation: 3.96,
  drops: [{ name: 'ダイヤ', icon: 'diamond' }, { name: 'ウィルフレッド', icon: 'will' }, { name: '白銀精霊', icon: 'platinum-sprit' }, { name: 'エレイン', icon: 'elain' }, { name: '刻水晶2', icon: 'time-crystal-2', set: 3 }]
}, {
  name: '大侵攻3',
  charisma: 40,
  stamina: 3,
  expectation: 3.84,
  drops: [{ name: 'ダイヤ', icon: 'diamond', set: 2 }, { name: 'ラセル', icon: 'lassell' }, { name: '金精霊', icon: 'gold-sprit' }, { name: 'グレイブ', icon: 'grave' }, { name: '刻水晶2', icon: 'time-crystal-2', set: 2 }]
}, {
  name: '大侵攻2',
  charisma: 35,
  stamina: 3,
  expectation: 3.66,
  drops: [{ name: 'ダイヤ', icon: 'diamond' }, { name: 'レオ', icon: 'leo' }, { name: '金精霊', icon: 'gold-sprit' }, { name: 'セシリー', icon: 'cecily' }, { name: '刻水晶2', icon: 'time-crystal-2', set: 3 }]
}, {
  name: '大侵攻1',
  charisma: 35,
  stamina: 3,
  expectation: 3,
  drops: [{ name: 'ルビー', icon: 'ruby' }, { name: 'ロイ', icon: 'roy' }, { name: '銀精霊', icon: 'silver-sprit' }, { name: 'ソーマ', icon: 'soma' }, { name: '刻水晶1', icon: 'time-crystal-1', set: 3 }]
}, {
  name: 'ドラゴニュート',
  charisma: 35,
  stamina: 3,
  expectation: 2.43,
  drops: [{ name: 'ルビー', icon: 'ruby' }, { name: 'ミーシャ', icon: 'misha' }, { name: '銀精霊', icon: 'silver-sprit' }, { name: 'ベルナール', icon: 'bell' }, { name: '刻水晶1', icon: 'time-crystal-1', set: 3 }]
}, {
  name: '竜を呼ぶ者',
  charisma: 30,
  stamina: 3,
  expectation: 2.43,
  drops: [{ name: '水晶', icon: 'crystal' }, { name: 'ヘクター', icon: 'hector' }, { name: '銅精霊', icon: 'bronze-sprit' }, { name: 'フィリス', icon: 'philis' }, { name: '刻水晶1', icon: 'time-crystal-1', set: 3 }]
}, {
  name: '地底からの侵略',
  charisma: 25,
  stamina: 2,
  expectation: 1.42,
  drops: [{ name: '水晶', icon: 'crystal' }, { name: 'バーガン', icon: 'bagan' }, { name: '銅精霊', icon: 'bronze-sprit' }, { name: 'モーティマ', icon: 'motima' }, { name: '刻水晶1', icon: 'time-crystal-1', set: 2 }]
}, {
  name: '大地の大穴',
  charisma: 20,
  stamina: 2,
  expectation: 0.71,
  drops: [{ name: '花束', icon: 'arus' }, { name: 'アルス', icon: 'arus' }, { name: '鉄精霊', icon: 'iron-sprit' }, { name: 'ハリッサ', icon: 'harissa' }, { name: '刻水晶1', icon: 'time-crystal-1' }]
}];
